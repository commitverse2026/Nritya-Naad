...
const DANCE_FORMS = [
  {
    ...
    description: "One of the oldest classical dance forms of India, rooted in the Natya Shastra. Known for its fixed upper torso, bent legs, and intricate footwork combined with expressive hand gestures (mudras).",
    keyFeatures: ["Nritta", "Nritya", "Natya", "Abhinaya"],
    color: "#C2185B", bg: "rgba(194,24,91,0.08)", border: "rgba(194,24,91,0.25)",
  },
  {
    id: 2,
    name: "Kathak",
    ...
    description: "Originating from the storytelling Kathakas of northern India, Kathak blends Hindu devotional themes with Mughal court aesthetics. Famous for rapid spins (chakkar) and intricate tatkaar footwork.",
    keyFeatures: ["Tatkaar", "Chakkar", "Thumri", "Abhinaya"],
    color: "#FF6B00", bg: "rgba(255,107,0,0.08)", border: "rgba(255,107,0,0.25)",
  },
  {
    id: 3,
    name: "Odissi",
    ...
    emoji: "🏛️",
    origin: "~2nd century BCE",
    description: "One of the earliest classical dance forms with roots in the Odisha temple tradition. Odissi is lyrical and sculpturesque, with the tribhangi posture (three-body bends) as its hallmark.",
    keyFeatures: ["Tribhangi", "Chouka", "Mangalacharan", "Abhinaya"],
    color: "#3949AB", bg: "rgba(57,73,171,0.08)", border: "rgba(57,73,171,0.25)",
  },
  {
    id: 4,
    name: "Kathakali",
    ...
    description: "A highly stylised dance-drama from Kerala, Kathakali is known for its elaborate makeup (chutti), vivid costumes, and expressive storytelling drawn from the Mahabharata and Ramayana.",
    keyFeatures: ["Chutti makeup", "Navarasas", "Mudras", "Padam"],
    color: "#00897B", bg: "rgba(0,137,123,0.08)", border: "rgba(0,137,123,0.25)",
  },
  {
    id: 5,
    name: "Kuchipudi",
    ...
    description: "From the village of Kuchipudi in Andhra Pradesh, this form is known for its fast rhythmic footwork, graceful movements, and unique tarangam — dancing on the rim of a brass plate.",
  ...
  },
  {
    ...
    emoji: "🌸",
    origin: "~15th century CE",
    description: "A gentle and lyrical dance form from Manipur, closely tied to Vaishnavism. The Ras Leela performances depicting Radha-Krishna are its most celebrated expressions.",
  ...
  },
  {
    ...
    description: "The 'dance of the enchantress' is a graceful, feminine solo form from Kerala with swaying movements evoking ocean waves and palm trees. Performed exclusively by women in traditional white and gold.",
  ...
  },
  {
    ...
    emoji: "🪷",
    origin: "~15th century CE",
    description: "Founded by the Vaishnavite saint Srimanta Shankardev, Sattriya originated in the sattra monasteries of Assam. It combines dance, music, and drama to narrate episodes from Vaishnavite literature.",
      ...
      <div style={{ marginBottom: "28px" }}>
        <input
          ...
          style={{
            ...
            border: `1.5px solid ${theme.color}30`, fontSize: "14px",
            color: "#3D1C00", outline: "none", marginBottom: "16px",
        ...
        {filtered.map((dance) => (
          <div
            ...
            style={{
              ...
              border: `1.5px solid ${dance.border}`, cursor: "pointer",
            ...
            <div>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                {selectedDance.keyFeatures.map((f) => (
                  <span key={f} style={{ padding: "5px 12px", borderRadius: "20px", background: selectedDance.bg, border: `1.5px solid ${selectedDance.border}`, fontSize: "12px", fontWeight: 500, color: selectedDance.color }}>
                    {f}
                  </span>
                ))}
              </div>
      ...
      <div style={{ padding: "48px 48px 80px", maxWidth: "960px", margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ background: "#fff", borderRadius: "24px", padding: "40px", border: "1.5px solid rgba(0,0,0,0.06)", marginBottom: "32px", position: "relative", overflow: "hidden" }}>
          ...
          <p style={{ fontSize: "15px", color: "#5D3A1A", lineHeight: 1.7, fontWeight: 300 }}>
            ...
            filter by region, search by name, and tap any card to learn about its history, key elements, and cultural roots.
          </p>
        </div>
