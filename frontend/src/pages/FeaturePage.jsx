...
export default function FeaturePage() {
  ...
  if (FEATURE_REDIRECTS[id]) {
    return <Navigate to={FEATURE_REDIRECTS[id]} replace />;
  }
    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "48px 48px 80px", maxWidth: "860px", margin: "0 auto", width: "100%" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "36px" }}>
          <Link to="/features" style={{ textDecoration: "none", fontSize: "13px", color: "#8B6452" }}>← All Features</Link>
          <span style={{ color: "#cbb", fontSize: "13px" }}>/</span>
          <span style={{ fontSize: "13px", color: theme.color, fontWeight: 500 }}>{feature?.name}</span>
        </div>
        <div style={{ background: "#fff", borderRadius: "24px", padding: "40px", border: "1.5px solid rgba(0,0,0,0.06)", marginBottom: "24px", position: "relative", overflow: "hidden" }}>
